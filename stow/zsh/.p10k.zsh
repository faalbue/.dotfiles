# Generated by Powerlevel10k configuration wizard on 2023-02-02 at 07:03 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    my_doppler_config       # doppler config
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  function prompt_my_sbt_version() {
    ...
    if [[ -n "$latest_sbt_version" && "$sbt_version" != "$latest_sbt_version" ]]; then
       p10k segment -s "NOT_UP_TO_DATE" -f 32 -i 'ﯶ' -t "⇣$sbt_version"
    else
       p10k segment -s "UP_TO_DATE" -f 32 -i 'ﯶ' -t "$sbt_version"
    fi
  }
